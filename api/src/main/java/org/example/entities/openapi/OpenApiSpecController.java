// /**
// This class is used to override the default way Spring handles 'Accept'
// headers, since we want to provide XML only for application/xml explicitely,
// NOT requests of the type "Accept: text/html, ..., application/xml"
// */
...
// @GetMapping(value = "${openapi.path}", produces =
...
// return data;
// }
// throw new Error("Invalid openapi spec format, must be one of [.yaml, .yml,
// .json]");
// }
// }